...
namespace DragAndDropExample
{
    class CustomGridDragAndDrop : GridDragDropManager 
    {
        ...
        protected GridControl GridControl { get { return AssociatedObject as GridControl; } }
        ...
        protected GridControl GetSourceGrid()
        {
            ...
            return parentRow != null ? ((RowData)parentRow.DataContext).View.DataControl as GridControl : GridControl;
        }
